# Docusaurus To PDF Converter (local MA fork)
...
* **Automatic Table of Contents (TOC) Generation**: Automatically generates a clickable PDF table of contents based on the Docusaurus sidebar structure (toggleable with `--disable-toc`).
...
* **Category Index Support**: Includes generated category index pages (from `category.json`) alongside regular documentation pages.

## Installation

```bash
npm install -g docusaurus-docs-to-pdf-ma
# or
yarn global add docusaurus-docs-to-pdf-ma
```

### Run locally without npm publishing
...
node dist/main.js --docs-url <docs site> --pdf-path <output>.pdf [options]

# or rebuild + run in one go
corepack yarn dev --docs-url <docs site> --pdf-path <output>.pdf [options]
```
...
```bash
docusaurus-docs-to-pdf-ma -h
# or
npx docusaurus-docs-to-pdf-ma -h
```
...
```bash
docusaurus-docs-to-pdf-ma --docs-url https://docusaurus.io/docs --pdf-path docusaurus.pdf --pdf-cover-image https://docusaurus.io/img/docusaurus_keytar.svg
# or
npx docusaurus-docs-to-pdf-ma --docs-url https://docusaurus.io/docs --pdf-path docusaurus.pdf --pdf-cover-image https://docusaurus.io/img/docusaurus_keytar.svg
```

**Skip auto-generated TOC**

```bash
docusaurus-docs-to-pdf-ma --docs-url https://docusaurus.io/docs --pdf-path docusaurus.pdf --disable-toc
```